...
--
--   Stadion prve utakmice je Valbruna u Rovinju, kako je Andrej
--   potvrdio. Prva verzija najave imala je Kunfin u Rovinjskom Selu, pa
--   je to ispravljeno i u sažetku i u tekstu.
--
...
Žminj - Ližnjan (Valbruna, Rovinj). Najzvučniji par kola. Ližnjan je prošlu sezonu završio drugi, odmah iza Rovinja, i sada je bez njega među prvim kandidatima za vrh. Žminj je prošle godine bio šesti. Domaćin utakmicu igra u Rovinju.
...
select slug, objavljen, slika_url,
       ...
       tekst like '%(Valbruna, Rovinj)%'                as stadion_je_valbruna
from public.clanci
where slug = 'najava-1-kola-4-nl-ns-rijeka-2627';
